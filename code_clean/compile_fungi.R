...
#### Title:   Function | Wrangle | Compile fungal community data
#### Author:  Tom Walker (thomas.walker@usys.ethz.ch)
#### Date:    15 July 2020
#### ---------------------------------------------------------------------------

compile_fungi <- function(raw_mcc, distance){
  ## Basic house-keeping ----
  ...
  ready <- map %>%
    ...
    select(insitu_code, V1:V316)
  # change column names
  columns <- raw_mcc$fun$data$`#OTU ID`
